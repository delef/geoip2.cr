...
describe GeoIP2::Model do
  describe GeoIP2::Model::Country do
  ...
  describe GeoIP2::Model::City do
    ip_address = "175.16.199.0"
    source_data = source_model_data("GeoIP2-City-Test", ip_address)
    model = GeoIP2::Model::City.new(source_data[:maxminddb_any], ["ja", "de"], ip_address)
    ...
    it "registered_country record" do
      model.registered_country.geoname_id.should eq(1814991)
    ...
    it "postal record" do
      model.postal.code.should be_nil
    end
  end

  describe GeoIP2::Model::Enterprise do
  ...
  describe GeoIP2::Model::AnonymousIp do
  ...
  describe GeoIP2::Model::ConnectionType do
    ip_address = "1.0.1.0"
  ...
  describe GeoIP2::Model::Domain do
    ip_address = "1.2.0.0"
  ...
  describe GeoIP2::Model::DensityIncome do
  ...
  describe GeoIP2::Model::UserCount do
